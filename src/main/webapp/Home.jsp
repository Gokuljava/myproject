	...
	<div class="smooth">
		<header>
			...
			<ul>
				...
				<li><a href="log.jsp">CompanyLogin</a></li>
				<li><a href="regfile.jsp">Job Seeker Registration</a></li>
		...
		<section id="one">
			<div class="content">
				<div>
					<h1><span> Job Seekers</span></h1>
					<p class="lead">Technology has changed the way job seekers search for jobs and employers find qualified employees. 
				...
				<div class="blur">
					<form action=Looginservlet method=post>
						<img
							src="Do.jpg" />
		...
		<section id="two">
			...
			<div class="blocks">
				<div class="block">
					<p>JobPortal Announces 2024 Best Companies for Veterans List</p>
				</div>
				<div class="block">
					<p>JobPortal Strengthens Staffing Leadership Team Ahead of Staffing World 2026</p>
				</div>
				<div class="block">
		...
		<footer id="bottom">
			...
			<div class="copy">
				<p>
					&copy; 2019 with <span>&#9829;</span> <a
						href="https://github.com/rakeshgowdan?tab=repositories" target="_blank">RakeshGowda</a>
				</p>
